...
st.set_page_config(
    page_title="KT Document Generator",
    page_icon="📚",
    layout="wide",
    initial_sidebar_state="expanded"
)

st.title("📚 Knowledge Transfer Document Generator")
st.markdown("Generate comprehensive KT documents from video demonstrations")
...
def main():
    ...
    if st.session_state.processing_complete and st.session_state.screenshots:
        ...
        with sub_column2:
            doc_type_options = {
                "kt_document": "📚 Knowledge Transfer"
            }
    ...
    if st.session_state.analysis_complete:
        if 'screenshots' in st.session_state and len(st.session_state.screenshots) > 0:
            ...
            with main_tab1:
                ...
                doc_type_options = {
                    "kt_document": "📚 Knowledge Transfer",
                    "user_story_generator": "📖 User Stories",
                    "meeting_summary": "📝 Meeting Summary", 
                    "general_documentation": "📄 General Docs"
                }
